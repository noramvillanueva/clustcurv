...
#' @param nboot Number of bootstrap repeats.Only for bootstrap method.
...
#' @param multiple.method Correction for multiple comparisons. See Details. Not used
#' in the case of the bootstrap method.
#'
#'@return
